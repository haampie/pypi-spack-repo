...
class PyAzureCliCore(PythonPackage):
    ...
    with default_args(type="run"):
        ...
        depends_on("py-azure-cli-nspkg@2:", when="@2.0.4:2.0.11,2.0.13:2.0.14,2.0.18:2.10")
        depends_on("py-azure-cli-telemetry", when="@2.0.44:2.11")
        ...
        depends_on("py-jmespath", when="@0.1.0-beta9:2.0.11,2.0.13:2.0.14,2.0.18:")
        ...
        depends_on("py-msrest@0.4.4:", when="@0.1.2-rc1:2.0.11,2.0.13:2.0.14,2.0.18:2.15")
        depends_on("py-msrestazure@0.6.3:", when="@2.4:2.24")
        depends_on("py-paramiko@2.0.8:2", when="@2.0.67:2.45")
        depends_on("py-pkginfo@1.5.0.1:", when="@2.5:")
        depends_on("py-pyjwt", when="@2.0.13:2.0.14,2.0.18:2.18")
