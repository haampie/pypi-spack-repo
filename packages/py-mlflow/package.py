...
class PyMlflow(PythonPackage):
    ...
    with default_args(type="run"):
        ...
        depends_on("py-click@7:", when="@1.7.1:")
        depends_on("py-cloudpickle@:2", when="@1.28:2.8")
        depends_on("py-cloudpickle", when="@1.7.1:1.26")
        depends_on("py-databricks-cli@0.8.7:", when="@1.7.1:2.10.1")
        depends_on("py-docker@4:6", when="@1.29:2.9")
        depends_on("py-docker@4:", when="@1.7.1:1.26")
        depends_on("py-entrypoints", when="@1.7.1:")
        depends_on("py-flask@:2", when="@1.28:2.7")
        depends_on("py-flask", when="@1.7.1:1.26")
        depends_on("py-gitpython@2.1:", when="@1.7.1:2.10")
        ...
        depends_on("py-gunicorn", when="@1.8:1.26 platform=linux")
        depends_on("py-gunicorn", when="@1.8:1.26 platform=freebsd")
        depends_on("py-gunicorn", when="@1.8:1.26 platform=darwin")
        depends_on("py-gunicorn", when="@1.8:1.26 platform=cray")
        depends_on("py-gunicorn", when="@1.7.1:1.7")
        ...
        depends_on("py-numpy", when="@1.7.1:1.26")
        depends_on("py-packaging@:21", when="@1.28:2.0")
        depends_on("py-pandas@:1", when="@1.28:2.1")
        depends_on("py-pandas", when="@1.7.1:1.26")
        depends_on("py-prometheus-flask-exporter", when="@1.7.1:1.26")
        depends_on("py-protobuf@3.12.0:4", when="@1.28:")
        depends_on("py-protobuf@3.6:", when="@1.7.1:1.17")
        ...
        depends_on("py-pyyaml", when="@1.7.1:1.17")
        depends_on("py-querystring-parser", when="@1.7.1:")
        depends_on("py-requests@2.17.3:", when="@1.7.1:")
