...
class PyDistributed(PythonPackage):
    ...
    with default_args(type="run"):
        depends_on("python@3.8:", when="@2022.2.1:2023.5.0")
        depends_on("python@3.7:", when="@2021.3.1:2022.2.0")
        depends_on("py-click@8.0.0:", when="@2023.3.1:")
        depends_on("py-click@6.6:", when="@:2022.10")
        depends_on("py-cloudpickle@1.5:")
        depends_on("py-contextvars", when="@:2021.3.0 ^python@:3.6")
        ...
        depends_on("py-msgpack@0.6:", when="@:2022")
        depends_on("py-packaging@20:", when="@2022:")
        depends_on("py-psutil@5.7:", when="@2023:2023.5.0")
        depends_on("py-psutil@5:", when="@:2022")
        depends_on("py-pyyaml@5.3.1:", when="@2023:")
        depends_on("py-pyyaml", when="@:2022")
        depends_on("py-setuptools", when="@:2022.2")
        depends_on("py-sortedcontainers@2.0.5:", when="@2023:")
        depends_on("py-sortedcontainers@:1,2.0.2:", when="@:2022")
        depends_on("py-tblib@1.6:")
        depends_on("py-toolz@0.10:", when="@2022.11.1:")
        depends_on("py-toolz@0.8.2:", when="@:2022.11.0")
        depends_on("py-tornado@6.0.3:6.1", when="@2022.7:2022.11")
        depends_on("py-tornado@6.0.3:", when="@2022.2.1:2022.6,2022.12:2023.5.0")
        depends_on("py-tornado@5.0:", when="@:2022.2.0 ^python@:3.7")
        depends_on("py-tornado@6.0.3:", when="@:2022.2.0 ^python@3.8:")
        depends_on("py-urllib3@1.24.3:", when="@2023:")
        depends_on("py-urllib3", when="@2022.4:2022")
        depends_on("py-zict@2.2:", when="@2023.4:2023.8")
        depends_on("py-zict@0.1.3:", when="@:2022")
    # END DEPENDENCIES
