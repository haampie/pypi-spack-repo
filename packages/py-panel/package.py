...
class PyPanel(PythonPackage):
    version("0.14.4", sha256="dd4fcf2fc7276cd3f0df110ce7a6197ac4040d74c4efdc8c092b23771c1f514d", url="https://pypi.org/packages/b6/2e/6f47d12d9cd6bf11a028f022b7839c49c8d3cc2e08131f84006b1ca4a3fa/panel-0.14.4-py2.py3-none-any.whl")
    ...
    with default_args(type="run"):
        ...
        depends_on("py-markdown", when="@:0.10.0-alpha4,0.10.0-alpha6:0.10.0-alpha7,0.10.0-alpha9,0.10.0-alpha11,0.10.0-alpha17:")
