...
class PySentrySdk(PythonPackage):
    ...
    variant("beam", default=False, description="beam")
    variant("bottle", default=False, description="bottle")
    variant("celery", default=False, description="celery")
    variant("chalice", default=False, description="chalice")
    variant("django", default=False, description="django")
    variant("falcon", default=False, description="falcon")
    variant("flask", default=False, description="flask")
    variant("httpx", default=False, description="httpx")
    variant("pure_eval", default=False, description="pure_eval")
    variant("pyspark", default=False, description="pyspark")
    variant("quart", default=False, description="quart")
    variant("rq", default=False, description="rq")
    variant("sanic", default=False, description="sanic")
