...
class PySentrySdk(PythonPackage):
    ...
    version("1.44.0", sha256="eb65289da013ca92fad2694851ad2f086aa3825e808dc285bd7dcaf63602bb18", url="https://pypi.org/packages/77/91/bdb2283b2ee15adb5e58c7e6c7020c5b8ebe52d32aef94176ce2a7c2e706/sentry_sdk-1.44.0-py2.py3-none-any.whl")
    ...
    with default_args(type="run"):
        ...
        depends_on("py-blinker@1.1:", when="@:0.1.0-rc1,0.1.0-rc3,0.1.0-rc5:0.1.0-rc6,0.1.0-rc11,0.1.0-rc14,0.1.0-rc16:0.1.0,0.1.2,0.4:0.4.0,0.5:0.5.1,0.5.4,0.6:0.6.1,0.6.6,0.6.8:0.7.0,0.7.3,0.7.12,0.7.14:0.7,0.8.1:0.8,0.12:0.12.2,0.13.1,0.15:0.20.0,0.20.2:+flask")
        depends_on("py-bottle@0.12.13:", when="@0.7.12,0.7.14:0.7,0.8.1:0.8,0.12:0.12.2,0.13.1,0.15:0.20.0,0.20.2:+bottle")
        ...
        depends_on("py-falcon@1.4.0:", when="@0.7.12,0.7.14:0.7,0.8.1:0.8,0.12:0.12.2,0.13.1,0.15:0.20.0,0.20.2:+falcon")
        depends_on("py-flask@0.11:", when="@0.15:0.20.0,0.20.2:1.5.8,1.5.10:+flask")
        depends_on("py-httpx@0.16:", when="@1.2:+httpx")
        depends_on("py-markupsafe", when="@1.23:+flask")
