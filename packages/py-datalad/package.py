...
class PyDatalad(PythonPackage):
    ...
    # BEGIN VARIANTS
    variant("downloaders-extra", default=False, description="downloaders-extra")
    variant("duecredit", default=False, description="duecredit")
    variant("full", default=False, description="full")
    variant("metadata-extra", default=False, description="metadata-extra")
    variant("misc", default=False, description="misc")
    ...
    with default_args(type="run"):
        ...
        depends_on("py-mutagen@1.36:", when="@0.14.6:0.14.7,0.15.1:0.15,0.17.10:0.17+metadata-extra")
        ...
        depends_on("py-python-xmp-toolkit", when="@0.14.6:0.14.7,0.15.1:0.15,0.17.10:0.17+metadata-extra")
