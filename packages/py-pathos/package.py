...
class PyPathos(PythonPackage):
    ...
    version("0.2.9", sha256="6a6ddb514ce2719f63fb88d5ec4f4490e436b636b54f1102d952c9f7c52f18e2", url="https://pypi.org/packages/e4/9c/30642d22a37149ebd677cc8e9446b7a50e830b2ab2cdf220aac90733249c/pathos-0.2.9-py2-none-any.whl")
    ...
    with default_args(type="run"):
        ...
        depends_on("py-dill@0.3.5.1:", when="@0.2.9:0.2")
        ...
        depends_on("py-multiprocess@0.70.13:", when="@0.2.9:0.2")
        ...
        depends_on("py-pox@0.3.1:", when="@0.2.9:0.2")
        ...
        depends_on("py-ppft@1.7:", when="@0.2.9:0.2")
