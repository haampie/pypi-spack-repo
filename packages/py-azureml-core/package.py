...
class PyAzuremlCore(PythonPackage):
    ...
    with default_args(type="run"):
        ...
        depends_on("py-azure-mgmt-resource@1.2.1:", when="@:1.9.0.0,1.10:1.10.0.post1,1.11:1.11.0.post1,1.12:1.12.0.post1,1.13:1.13.0.0,1.14:1.14.0.0")
        ...
        depends_on("py-pyjwt", when="@:1.13.0.post1,1.14:1.14.0.post1,1.15:1.15.0.0,1.16:1.16.0.post1,1.17:1.17.0.0,1.22:")
