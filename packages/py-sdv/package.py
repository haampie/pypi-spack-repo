...
class PySdv(PythonPackage):
    ...
    version("0.14.0", sha256="e9f3e28b913e2723accb2c109fc95be6b7ffc50f0365c8699cd7e5a9cad79c38", url="https://pypi.org/packages/47/9b/4444f38c9b4d1c8e906660319cc52c3de84bebc5c8e8ff593a2794363711/sdv-0.14.0-py2.py3-none-any.whl")
    version("0.13.1", sha256="b5a0b8826d2f1bf624292afade09a4815726ef568da49e001ca10bcde62f826a", url="https://pypi.org/packages/f6/4b/247fccbeff223ed4ac0261ddfca43ccded520701752f1d7398b286b9f97a/sdv-0.13.1-py2.py3-none-any.whl")
    # END VERSIONS
    ...
    with default_args(type="run"):
        ...
        depends_on("py-sdmetrics@0.4.1:0.4.1.0,0.4.2:0.4", when="@0.13.1:0.14,0.15.0.dev:0.15.0.dev0")
