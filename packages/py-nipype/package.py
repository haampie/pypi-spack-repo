...
class PyNipype(PythonPackage):
    ...
    with default_args(type="run"):
        ...
        depends_on("py-networkx@1.9:", when="@:1.5")
        depends_on("py-neurdflib", when="@:1.5.0-rc1")
        depends_on("py-nibabel@2.1:")
        depends_on("py-numpy@1.17.0:", when="@1.8:")
        depends_on("py-numpy@1.15.3:", when="@1.6.1:1.7")
        depends_on("py-numpy@1.13.0:", when="@1.5:1.6.0 ^python@:3.6")
        depends_on("py-numpy@1.12.0:", when="@1.3.0:1.4 ^python@:3.6")
        depends_on("py-numpy@1.15.3:", when="@:1.6.0 ^python@3.7:")
