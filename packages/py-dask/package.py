...
class PyDask(PythonPackage):
    ...
    # BEGIN VARIANTS
    variant("array", default=False, description="array")
    variant("bag", default=False, description="bag")
    variant("complete", default=False, description="complete")
    variant("dataframe", default=False, description="dataframe")
    variant("delayed", default=False, description="delayed")
    variant("diagnostics", default=False, description="diagnostics")
    ...
    with default_args(type="run"):
        ...
        depends_on("py-bokeh@2.4.2:2.4.2.0,2.4.3-rc1:2", when="@2022.10.1:2022.10,2022.11.1:2023.3+diagnostics")
        depends_on("py-bokeh@2.4.2:2.4.2.0,2.4.3-rc1:2", when="@2022.10.1:2022.10,2022.11.1:2023.3+complete")
        depends_on("py-bokeh@2.4.2:2.4.2.0,2.4.3-rc1:", when="@2022.3:2022.10.0,2022.11:2022.11.0,2023.4:+diagnostics")
        depends_on("py-bokeh@2.1.1:", when="@2021.12:2022.2+diagnostics")
        depends_on("py-bokeh@2.1.1:", when="@2021.12:2022.2+complete")
        ...
        depends_on("py-cloudpickle@0.2.2:", when="@:2021.3.0+delayed")
        depends_on("py-cloudpickle@0.2.2:", when="@:2021.3.0+complete")
        depends_on("py-cloudpickle@0.2.2:", when="@:2021.3.0+bag")
        ...
        depends_on("py-distributed@2022.2.1:2022.2", when="@2022.2.1:2022.2+complete")
        ...
        depends_on("py-distributed@2:", when="@:2021.2+distributed")
        depends_on("py-distributed@2:", when="@:2021.2+complete")
        depends_on("py-fsspec@2021.9:", when="@2023.4.1:")
        depends_on("py-fsspec@0.6:", when="@2021.3.1:2023.4.0")
        depends_on("py-fsspec@0.6:", when="@:2021.3.0+dataframe")
        depends_on("py-fsspec@0.6:", when="@:2021.3.0+complete")
        depends_on("py-fsspec@0.6:", when="@:2021.3.0+bag")
        ...
        depends_on("py-partd@0.3.10:", when="@:2021.3.0+dataframe")
        depends_on("py-partd@0.3.10:", when="@:2021.3.0+complete")
        depends_on("py-partd@0.3.10:", when="@:2021.3.0+bag")
        depends_on("py-pyarrow@7:", when="@2023.3.1:+complete")
        depends_on("py-pyyaml@5.3.1:", when="@2022:")
        depends_on("py-pyyaml", when="@:2021")
        depends_on("py-toolz@0.10:", when="@2023.4.1:")
        depends_on("py-toolz@0.8.2:", when="@2021.3.1:2023.4.0")
        depends_on("py-toolz@0.8.2:", when="@:2021.3.0+delayed")
        depends_on("py-toolz@0.8.2:", when="@:2021.3.0+dataframe")
        depends_on("py-toolz@0.8.2:", when="@:2021.3.0+complete")
        depends_on("py-toolz@0.8.2:", when="@:2021.3.0+bag")
        depends_on("py-toolz@0.8.2:", when="@:2021.3.0+array")
    # END DEPENDENCIES
