...
class PyDask(PythonPackage):
    ...
    with default_args(type="run"):
        ...
        depends_on("py-bokeh@2.4.2:2.4.2.0,2.4.3-rc1:", when="@2022.3:2022.10.0,2022.11:2022.11.0+complete")
        ...
        depends_on("py-distributed@2023.3.2:2023.3.2.0", when="@2023.3.2:2023.3+complete")
        depends_on("py-distributed@2023.3.1", when="@2023.3.1+distributed")
        depends_on("py-distributed@2023.3.1", when="@2023.3.1+complete")
        depends_on("py-distributed@2023.3:2023.3.0", when="@2023.3:2023.3.0+distributed")
        depends_on("py-distributed@2023.3:2023.3.0", when="@2023.3:2023.3.0+complete")
        depends_on("py-distributed@2023.2.1:2023.2", when="@2023.2.1:2023.2+distributed")
        depends_on("py-distributed@2023.2.1:2023.2", when="@2023.2.1:2023.2+complete")
        depends_on("py-distributed@2023.2:2023.2.0", when="@2023.2:2023.2.0+distributed")
        depends_on("py-distributed@2023.2:2023.2.0", when="@2023.2:2023.2.0+complete")
        depends_on("py-distributed@2023.1.1:2023.1", when="@2023.1.1:2023.1+distributed")
        depends_on("py-distributed@2023.1.1:2023.1", when="@2023.1.1:2023.1+complete")
        depends_on("py-distributed@2023:2023.1.0", when="@2023:2023.1.0+distributed")
        depends_on("py-distributed@2023:2023.1.0", when="@2023:2023.1.0+complete")
        depends_on("py-distributed@2022.12.1:2022", when="@2022.12.1:2022+distributed")
        depends_on("py-distributed@2022.12.1:2022", when="@2022.12.1:2022+complete")
        depends_on("py-distributed@2022.12:2022.12.0", when="@2022.12:2022.12.0+distributed")
        depends_on("py-distributed@2022.12:2022.12.0", when="@2022.12:2022.12.0+complete")
        ...
        depends_on("py-pyarrow-hotfix", when="@2023.11:+complete")
