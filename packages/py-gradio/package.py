...
class PyGradio(PythonPackage):
    ...
    with default_args(type="run"):
        ...
        depends_on("py-fastapi", when="@2.3.0-beta99:2.3.0-beta102,2.6.1-alpha0,2.6.4-beta3,2.7:2.7.0-beta70,2.7.1:")
        ...
        depends_on("py-jinja2", when="@2.3.0-beta99:2.3.0-beta102,2.9-beta11:2.9.0-beta10,2.9.2:3.36")
        ...
        depends_on("py-orjson", when="@2.3.0-beta99:2.3.0-beta102,2.7.0-beta70,2.8.0-beta22,2.8.3:3.36")
        ...
        depends_on("py-python-multipart", when="@2.3.0-beta99:2.3.0-beta102,2.6.1-alpha0,2.6.4-beta3,2.7:2.7.0-beta70,2.7.1:4.19.0")
