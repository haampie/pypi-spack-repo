...
class PyScipy(PythonPackage):
    ...
    version("1.12.0-rc1", sha256="93483e58d13e2b4cbeb70f0b8aa01d19baddfd2e7f5f1275986baf3c0850e5c5", url="https://pypi.org/packages/ac/e5/412d60f68841286c7c11a3790dc83545647b618e7ed006bc3630667d2a8f/scipy-1.12.0rc1.tar.gz")
    ...
    version("1.9.0-rc3", sha256="b3b14c1d6c79c1c8edbae120c4b87c863907805e187e17a38de5f72f1735769f", url="https://pypi.org/packages/57/72/484c38e5b814b48b41ac6432ef69077f2e7c8094925d3ce17bc3d61359b0/scipy-1.9.0rc3.tar.gz")
    version("1.9.0-rc2", sha256="83101d8bcac69c4201ff1aed52f9f41897fb0ba66e54422d2808df507126e626", url="https://pypi.org/packages/5a/87/27f9ee75c32138d6eaabff2b91744c97a3fdbbbdd78948372dac93e0079f/scipy-1.9.0rc2.tar.gz")
    version("1.9.0-rc1", sha256="d949aa1ad680be92b3363a60d91c17144f8f62f4236f65c2c45efed455698214", url="https://pypi.org/packages/87/82/8b9bf8bb8030f1eef281ad2af87cc648e06e4a4974c2b9201a57d991b12c/scipy-1.9.0rc1.tar.gz")
    ...
    version("1.7.0-rc2", sha256="bb5598f8e349e77a9f05d2be605a75b5752648669a0886379b257a449fce244b", url="https://pypi.org/packages/a2/ae/ef8b23f5383403a597f2f79df44124a9b8f011a8beb1bca4c6b663a61d15/scipy-1.7.0rc2.tar.gz")
    ...
    with default_args(type="run"):
        ...
        depends_on("python@:3.11", when="@1.9:1.9.0-rc2,1.10")
        depends_on("python@:3.10", when="@1.7.2:1.8")
        depends_on("python@:3.9", when="@1.6.2:1.7.1")
        depends_on("py-numpy@1.22.4:", when="@1.13:")
        depends_on("py-numpy@1.22.4:1", when="@1.12")
